...
public class CiliaModified : MonoBehaviour
{
    ...
    private static CiliaModified instance;

    public static CiliaModified Instance
    {
        get
        {
            if (instance == null)
            {
                instance = FindObjectOfType<CiliaModified>();
            }
            return instance;
        }
    }
    ...
    void Start()
    {
        ...
        {
            Debug.Log("Failed to connect to SDK: " + e);
            mIsConnected = false;
            return;
        }
